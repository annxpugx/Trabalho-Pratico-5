...
class TabelaHash {
    ...
    private String tabela[] = new String[30];
    private int tamanhoTabela = 21;
    private int reserva = tamanhoTabela;

    private int hash(int altura){
        return (int) altura % tamanhoTabela;
    }
    ...
    private void inserir(String s, int a){
        ...
        if(a < tamanhoTabela && tabela[a] == null){
            tabela[a] = s;
        } else if (reserva < tabela.length){
            tabela[reserva] = s;
            reserva++;
        }
    }
